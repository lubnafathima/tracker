export default function Empty({ setActiveComponent }) {
  return (
    <>
      <main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-6 text-pretty text-lg font-normal text-gray-500 sm:text-xl/8">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            >
              Compose <span aria-hidden="true">&rarr;</span>
            </button>
          </div>
        </div>
      </main>
