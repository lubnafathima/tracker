...
import { fetchMessages, markMessageAsRead } from "../utils/MessageService";
...
const Inbox = () => {
  ...
  const handleReadMessage = async (msgId, message) => {
              ...
              >
                <div className="flex w-0 flex-1 items-center">
                  <div className="ml-4 flex min-w-0 flex-1 gap-2">
                    <span className="truncate font-medium">{msg.from}</span>
                  </div>
                </div>
                <div className="ml-4 flex-shrink-0">
                  <button
                    onClick={() => handleReadMessage(msg.id, msg)}
